...
const Footer = () => {
  ...
  return (
    <footer className="bg-brand-dark text-brand-light py-10"> {/* Reduced from py-12 */}
      <div className="container mx-auto px-4 text-center space-y-6"> {/* Reduced from space-y-8 */}
        ...
        <div className="flex justify-center py-2"> {/* Reduced from py-4 */}
          <DynamicImage
        ...
        {/* Copyright Notice */}
        <div className="pt-6 text-sm text-brand-light/70"> {/* Reduced from pt-8 */}
