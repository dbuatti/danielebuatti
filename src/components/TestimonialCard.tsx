...
const TestimonialCard: React.FC<TestimonialCardProps> = ({ quote, author, title }) => {
  return (
    <Card className="bg-brand-light dark:bg-brand-dark shadow-soft border-brand-secondary dark:border-brand-secondary/50 p-6 flex flex-col items-center text-center hover:shadow-lifted hover:scale-[1.02] transition-all duration-300"> {/* Added hover effects */}
