      ...
      return (
          <Alert variant="destructive">
              ...
              <AlertDescription className="space-y-4">
                <p>Quote data is corrupted: No versions found in quote details.</p>
                <Button 
          ...
          <CardContent className="space-y-4">
            <div className="flex flex-col space-y-2">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 text-center">
                {accepted_at ? `Accepted on ${safeFormatDate(accepted_at)}` :
                  rejected_at ? `Rejected on ${safeFormatDate(rejected_at)}` :
        ...
        <Card className="lg:col-span-2 bg-brand-light dark:bg-brand-dark-alt shadow-lg border-brand-secondary/50">
          ...
          <CardContent className="grid grid-cols-2 gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-lg">{safeFormatDate(quote.event_date)}</p>
            </div>
            <div className="flex flex-col">
            ...
            {versions.map((version) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Created: {safeFormatDate(version.created_at)}
                </p>
