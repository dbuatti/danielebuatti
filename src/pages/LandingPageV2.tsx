  ...
  return (
    <div className="min-h-screen bg-brand-light dark:bg-brand-dark text-brand-dark dark:text-brand-light">
      ...
      <main className="container mx-auto px-4 space-y-24">
        {/* Hero Section - Immersive Background Image */}
        <section id="home" className="relative h-[80vh] flex items-center justify-center text-center overflow-hidden rounded-xl shadow-2xl mt-8">
          <DynamicImage
            src="/headshot.jpeg"
            ...
            height={1080}
          />
          <div className="relative z-10 p-8 max-w-4xl text-brand-light bg-brand-dark/50 rounded-lg backdrop-blur-sm space-y-6">
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight text-brand-primary drop-shadow-lg">
              Unlock Your True Voice. Master Your Presence.
            </h1>
            <p className="text-2xl md:text-3xl font-semibold text-brand-light drop-shadow-md">
        ...
        {/* About Me Section - Staggered Layout */}
        <section id="about" className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <div className="relative flex justify-center md:justify-end">
            <DynamicImage
              ...
              className="w-full max-w-md h-auto rounded-xl shadow-2xl object-cover border-2 border-brand-secondary transform rotate-3 hover:rotate-0 transition-transform duration-500"
              width={400}
              height={500}
            />
            <div className="absolute -bottom-8 -left-8 bg-brand-secondary/20 dark:bg-brand-dark/30 p-6 rounded-xl shadow-lg hidden md:block">
        ...
        {/* Education & Expertise - Combined Section */}
        <section className="max-w-6xl mx-auto py-16">
          <div className="grid lg:grid-cols-2 gap-12">
            <Card className="bg-brand-light dark:bg-brand-dark shadow-lg border-brand-secondary hover:shadow-xl hover:scale-[1.01] transition-all duration-300 p-8">
        ...
        {/* Greenroom Awards Image Section */}
        <section className="max-w-5xl mx-auto text-center py-12 bg-brand-secondary/10 dark:bg-brand-dark/30 rounded-xl shadow-lg">
          <DynamicImage
            src="/greenroom.jpeg"
            alt="Daniele Buatti at the Greenroom Awards"
            className="w-full max-w-xl h-auto rounded-xl shadow-2xl object-cover border-2 border-brand-secondary mx-auto transform scale-105 hover:scale-100 transition-transform duration-500"
            width={600}
            height={800}
          />
        ...
        {/* Image Section: Daniele Smile Host BU */}
        <section className="max-w-5xl mx-auto text-center py-12 bg-brand-secondary/10 dark:bg-brand-dark/30 rounded-xl shadow-lg">
          <DynamicImage
            src="/daniele-smile-host-bu.jpeg"
            alt="Daniele Buatti smiling and interacting with a host at Broadway Unplugged"
            className="w-full max-w-2xl h-auto rounded-xl shadow-2xl object-cover border-2 border-brand-secondary mx-auto transform -rotate-2 hover:rotate-0 transition-transform duration-500"
            width={800}
            height={533}
          />
          <p className="text-sm text-brand-dark/70 dark:text-brand-light/70 mt-4">
        ...
        {/* Image Section: Daniele Calm at Piano */}
        <section className="max-w-5xl mx-auto text-center py-12 bg-brand-secondary/10 dark:bg-brand-dark/30 rounded-xl shadow-lg">
          <DynamicImage
        ...
        {/* My Approach Section - Visualized */}
        <section id="approach" className="max-w-6xl mx-auto space-y-10">
        ...
        {/* Image Section: Tulips */}
        <section className="max-w-5xl mx-auto text-center py-12 bg-brand-secondary/10 dark:bg-brand-dark/30 rounded-xl shadow-lg">
          <DynamicImage
            src="/tulips.jpeg"
            alt="Daniele Buatti smiling with tulips in a garden"
            className="w-full max-w-2xl h-auto rounded-xl shadow-2xl object-cover border-2 border-brand-secondary mx-auto transform scale-105 hover:scale-100 transition-transform duration-500"
            width={800}
            height={533}
          />
          <p className="text-sm text-brand-dark/70 dark:text-brand-light/70 mt-4">
        ...
        <section className="max-w-6xl mx-auto text-center space-y-10 py-16 bg-brand-secondary/20 dark:bg-brand-dark/50 rounded-xl shadow-lg">
        ...
        <section id="contact" className="text-center max-w-4xl mx-auto space-y-8">
          ...
          <div className="mt-8 p-8 bg-brand-secondary/10 dark:bg-brand-dark/30 rounded-xl shadow-lg">
            <ContactForm />
          </div>
